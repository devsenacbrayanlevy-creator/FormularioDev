...
//Função para exibir mensagem de erro e adicionar classe de erro
function setErrorFor(input, message) {
    const formControl = input.parentElement;
    const small = formControl.querySelector("small");
    //adicionar mensagem de erro
    small.innerText = message;
    //adicionar a classe error e remover classe success
    formControl.className = "form-control error";
}

//criar função para adicionar classe success e remover classe error
function setSuccessFor (input) {
    const formControl = input.parentElement;
    // adicionar a classe success e remover classe error
...
function verSenha(inputId, botao) {
